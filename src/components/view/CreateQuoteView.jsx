    ...
    <Container maxWidth>
      <Grid container>
              ...
              <Accordion>
                ...
                <AccordionDetails>
                  <Grid container alignItems={'center'} gap={'0.5rem'}>
                    <Grid height={'20px'} width={'20px'} style={{ background: 'gray' }} />
        ...
        <Grid md={10}>
          ...
          <Grid md={12} container style={{ background: '' }} gap={''} justifyContent={'space-between'}>
            <Grid item md={7} style={{ background: '' }} padding={'0'}>
              {/* #1 */}

              <Card elevation={6} style={{ height: '400px', borderRadius: '16px' }}>
                <Grid container direction={'column'} md={12}>
                  ...
                  >
                    ...
                    >
                      ...
                      <TextField placeholder="Ingresa descripción" rows={8} multiline />
                    </Grid>

                    <Grid item md={6} padding={'1rem'} style={{ background: '' }}>
                      <Typography align="center" color={'black'} fontWeight={'bold'}>
                        Factura
                      </Typography>
                      ...
                      <Grid
                        ...
                        margin={'1rem 0'}
                      >
                        <Grid item container alignItems={'center'} style={{ background: '' }}>
                          <Grid item md={6}>
                          ...
                          <Grid item md={6}>
                            <Autocomplete
                              ...
                              renderInput={params => <TextField {...params} label="Divisa" />}
                            />
                          </Grid>
                        </Grid>
                        <Grid item container alignItems={'center'} style={{ background: '' }}>
                        ...
                        <Grid item container alignItems={'center'} margin={'3rem 0'} style={{ background: '' }}>
                          <Grid item md={6}>
            ...
            <Grid item md={4} style={{ background: '' }}>
              <Card elevation={6} style={{ height: '400px', borderRadius: '16px' }}>
                <Grid container direction={'column'} md={12}>
                  <Grid item container md={12} alignItems={'center'} padding={'1rem 1.5rem'}>
                    <Grid item md={8}>
                      <Typography color={'black'} fontWeight={'bold'}>
                        Datos del cliente
                      </Typography>
                  ...
                  >
                    ...
                    <Grid item md={12} container>
                      <Grid item md={6} container direction={'column'}>
                        ...
                        <Grid item>
                          <Typography color={'gray'}>38/9 Future Niharika</Typography>
                        </Grid>
                      </Grid>
                    </Grid>
                  </Grid>
                  <Grid item container justifyContent={'flex-end'} padding={'0 1rem'} style={{ background: '' }}>
